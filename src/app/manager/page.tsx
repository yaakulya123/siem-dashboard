...
export default function ManagerDashboard() {
    ...
    return (
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">{selectedClient.organization} • {selectedClient.industry}</p>
            </div>
            <div className={clsx('px-3 py-1 rounded-full text-sm font-medium', getStatusBg(selectedClient.status))}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <button className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors text-left">
            <EyeIcon className="h-8 w-8 text-blue-400 mb-3" />
            <h3 className="text-white font-semibold mb-2">View Client Dashboard</h3>
            <p className="text-gray-400 text-sm">Access real-time security operations</p>
          </button>

          <button className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-green-500 transition-colors text-left">
            <TicketIcon className="h-8 w-8 text-green-400 mb-3" />
            <h3 className="text-white font-semibold mb-2">Manage Tickets</h3>
            <p className="text-gray-400 text-sm">Review and assign security incidents</p>
          </button>

          <button className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-purple-500 transition-colors text-left">
            <ChartBarIcon className="h-8 w-8 text-purple-400 mb-3" />
            <h3 className="text-white font-semibold mb-2">Analytics & Reports</h3>
            <p className="text-gray-400 text-sm">Generate security insights</p>
          </button>

          <button className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-yellow-500 transition-colors text-left">
            <Cog6ToothIcon className="h-8 w-8 text-yellow-400 mb-3" />
            <h3 className="text-white font-semibold mb-2">Configuration</h3>
            <p className="text-gray-400 text-sm">Manage client settings</p>
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">{selectedClient.alerts}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-gray-400 text-sm">Analysts Online</p>
                <p className="text-2xl font-bold text-white">{selectedClient.analysts}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-gray-400 text-sm">Protected Endpoints</p>
                <p className="text-2xl font-bold text-white">{selectedClient.endpoints}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">{selectedClient.uptime}</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">SOC Client Management</h1>
        <p className="text-gray-400">Monitor and manage security operations for all clients</p>
      </div>
        ...
        <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white">{totalAnalysts}</p>
            </div>
          </div>
        </div>
      ...
      <div>
        <h2 className="text-xl font-semibold text-white mb-4">Client Security Operations</h2>
            ...
            >
              ...
              <div className="p-6 border-b border-gray-700">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className={clsx('px-2 py-1 rounded text-xs font-medium', getStatusBg(client.status))}>
                    <span className={getStatusColor(client.status)}>
                      {client.status}
                    </span>
                  </div>
                </div>
                <p className="text-gray-400 text-sm">{client.organization}</p>
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">{client.alerts}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Analysts Online</span>
                  <span className="text-white font-medium">{client.analysts}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Protected Endpoints</span>
                  <span className="text-white font-medium">{client.endpoints}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Uptime</span>
                  <span className="text-white font-medium">{client.uptime}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">{client.lastActivity}</span>
                </div>
              </div>
